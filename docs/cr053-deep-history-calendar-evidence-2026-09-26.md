...
> CR-054 之后这段输出已部分过期：2016 年已按公告原文升级为 `official-notice`，同样请求不再被拒；
> 仍被拒绝的年份只剩 2020（该年有一处休市日无公告原文支撑）。见
> [CR-054 实录](cr054-official-notice-calendar-2026-09-26.md) 第 6 节。
